...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'tenant_admin' => [
            'driver' => 'mysql',
            'url' => env('TENANT_ADMIN_DB_URL', env('DB_URL')),
            'host' => env('TENANT_ADMIN_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('TENANT_ADMIN_DB_PORT', env('DB_PORT', '3306')),
            'database' => env('TENANT_ADMIN_DB_DATABASE', env('DB_DATABASE', 'artdent_admin')),
            'username' => env('TENANT_ADMIN_DB_USERNAME', env('DB_USERNAME', 'root')),
            'password' => env('TENANT_ADMIN_DB_PASSWORD', env('DB_PASSWORD', '')),
            'unix_socket' => env('TENANT_ADMIN_DB_SOCKET', env('DB_SOCKET', '')),
            'charset' => env('TENANT_ADMIN_DB_CHARSET', env('DB_CHARSET', 'utf8mb4')),
            'collation' => env('TENANT_ADMIN_DB_COLLATION', env('DB_COLLATION', 'utf8mb4_unicode_ci')),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
        ...
        'crm' => [
            ...
            'database' => env('CRM_DB_DATABASE', 'artdent_dev'),
            'username' => env('CRM_DB_USERNAME', 'fer_dev'),
            'password' => env('CRM_DB_PASSWORD', 'password_local'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',

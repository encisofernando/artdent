        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="flex flex-col gap-6 font-sans max-w-4xl mx-auto">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        <h1 className={`text-2xl font-extrabold tracking-tight ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>Nueva Oferta</h1>
                        <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Crear una oferta o promoción para el e-commerce</p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    className={inp}
                                    placeholder="Ej. Promo Verano, 2x1 en Resinas"
                                    required
                                />

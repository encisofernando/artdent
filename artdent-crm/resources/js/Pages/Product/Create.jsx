            ...
            <div className="flex flex-col gap-6 font-sans max-w-5xl mx-auto">
                ...
                <form onSubmit={submit} className="flex flex-col gap-6">
                    ...
                    `}>
                        ...
                        <div>
                            <label className={labelClasses}>Subir Imágenes (Opcional)</label>
                            <input
                                type="file"
                                multiple
                                accept="image/*"
                            ...
                            <p className={`text-xs mt-2 ${isDark ? 'text-slate-500' : 'text-slate-400'}`}>
                                Puedes seleccionar múltiples imágenes a la vez. La primera será utilizada como portada en la tienda.
                            </p>
                        </div>
                    </div>

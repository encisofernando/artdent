                ...
                <form onSubmit={submit} className="flex flex-col gap-5">
                    ...
                    <div className={`rounded-2xl border p-6 shadow-sm ${card}`}>
                        <div className="flex items-center gap-2 mb-2">
                            <KeyRound size={15} style={{ color: B.blue }} />
                        ...
                        <p className={`text-xs mb-4 ${isDark ? 'text-slate-500' : 'text-slate-400'}`}>
                            Dejá los campos vacíos para mantener la contraseña actual.
                        </p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Field label="Nueva contraseña" error={errors.password} isDark={isDark}>
                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        <Button type="submit" disabled={processing}
                            style={{ background: B.green }} className="text-white gap-2">
                            <Save size={15} />

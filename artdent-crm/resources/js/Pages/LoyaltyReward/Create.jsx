...
export default function Create({ auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('loyalty-rewards.store'));
    };
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        ...
                        <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                            Definí cuántos puntos hacen falta para este descuento
                        </p>
                    </div>
                ...
                <div className={section}>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div className="sm:col-span-2">
                            ...
                            <input className={inp} value={data.name} onChange={e => setData('name', e.target.value)} placeholder="Ej: $2000 de descuento" />
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input className={inp} type="number" min="1" step="1" value={data.points_cost} onChange={e => setData('points_cost', e.target.value)} placeholder="500" />
                            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input className={`${inp} pl-7`} type="number" min="0" step="0.01" value={data.discount_amount} onChange={e => setData('discount_amount', e.target.value)} placeholder="2000.00" />
                            </div>

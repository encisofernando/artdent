...
export default function Edit({ auth, item }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        phone: item.phone || '',
        price: item.price ?? '',
        zone: item.zone || 'Formosa Capital',
        notes: item.notes || '',
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('shipping-moto-companies.update', item.id));
    };
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input className={`${inp} pl-7`} type="number" min="0" step="0.01" value={data.price} onChange={e => setData('price', e.target.value)} />
                            </div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <input className={inp} value={data.zone} onChange={e => setData('zone', e.target.value)} />

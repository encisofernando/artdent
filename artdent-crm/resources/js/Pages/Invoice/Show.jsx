                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        {shareUrl && (
                            <button
                                onClick={copyLink}
                                className={`flex items-center gap-2 px-4 py-2.5 min-h-[40px] rounded-xl text-sm font-semibold border transition-all
                        ...
                        {shareUrl && (
                            <a href={`https://wa.me/?text=${waText}`} target="_blank" rel="noopener noreferrer">
                                <button className="flex items-center gap-2 px-4 py-2.5 min-h-[40px] rounded-xl text-sm font-semibold text-white transition-all hover:shadow-lg"
                        ...
                        <button
                            onClick={handlePrint}
                            className="flex items-center gap-2 px-4 py-2.5 min-h-[40px] rounded-xl text-sm font-semibold text-white transition-all hover:shadow-lg"
                            style={{ background: `linear-gradient(90deg, ${AD.blue}, ${AD.teal})` }}
                        >
                            <Download size={15} />
                            Guardar PDF

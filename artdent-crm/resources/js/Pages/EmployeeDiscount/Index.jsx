        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="flex flex-col gap-6 font-sans max-w-5xl mx-auto">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button onClick={openCreate} className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold text-white" style={{ background: 'linear-gradient(90deg, #9C3939, #9C6149)' }}>
            ...
            <Modal open={modal} onClose={() => setModal(false)} title={editing ? 'Editar Descuento' : 'Nuevo Descuento'} isDark={isDark}>
                <form onSubmit={submitForm} className="flex flex-col gap-4">
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        <button type="submit" disabled={processing} className="inline-flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-bold text-white disabled:opacity-50" style={{ background: 'linear-gradient(90deg, #9C3939, #9C6149)' }}><Save size={14} /> Guardar</button>
                    </div>
                </form>
            </Modal>
        </AuthenticatedLayout>

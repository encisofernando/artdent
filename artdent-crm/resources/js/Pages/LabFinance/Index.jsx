    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="flex flex-col gap-6 font-sans">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <button
                            type="button"
                            onClick={handlePrint}
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-600 text-white font-bold text-sm hover:bg-emerald-700"
                        >
                            <Printer size={16} />
                            Imprimir Reporte
                        </button>
                ...
                <div className={`rounded-2xl border p-4 flex flex-col xl:flex-row gap-3 ${card}`}>
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 pr-3 py-2 rounded-xl border ${input}`}
                        />
                    </div>
                    <div className="flex items-center gap-2">
                        <Calendar className="h-4 w-4 text-slate-400" />
                        <input type="date" value={from} onChange={(e) => setFrom(e.target.value)} className={`px-3 py-2 rounded-xl border ${input}`} />
                        <span className={sub}>a</span>
                        <input type="date" value={to} onChange={(e) => setTo(e.target.value)} className={`px-3 py-2 rounded-xl border ${input}`} />
                    </div>
                </div>

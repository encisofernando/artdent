...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .toolbar-brand img { height: 36px; object-fit: contain; }
        ...
        .footer-logo img { height: 26px; object-fit: contain; }
...
<body>
    ...
    <div class="toolbar">
        <div class="toolbar-brand">
            <img src="/assets/logo-artdent-color.png" alt="ArtDent" onerror="this.style.display='none'">
            <span>ArtDent Laboratorio Odontológico</span>
        </div>
        <div class="toolbar-actions">
            ...
            <a href="https://wa.me/?text={{ urlencode('Hola! Te comparto el presupuesto ' . $quote->quote_number . ' de ArtDent Laboratorio Odontológico. Podés verlo aquí: ' . route('quotes.public', $quote->public_token)) }}"
    ...
    <div class="paper">
        ...
        <div class="emisor">
            <div class="emisor-grid">
                <div>
                    <div class="emisor-name">ArtDent Laboratorio Odontológico</div>
                    <div class="emisor-detail">
                        Laboratorio Odontológico<br>
                        Argentina
                    </div>
                </div>
            ...
            <div class="footer">
                <div class="footer-left">
                    <div class="footer-logo">
                        <img src="/assets/logo-artdent-icon.png" alt="ArtDent" onerror="this.style.display='none'">
                    </div>

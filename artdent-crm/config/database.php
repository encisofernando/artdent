    ...
    */
    ...
    'connections' => [
        ...
        'central' => [
            ...
            'database' => env('CENTRAL_DB_DATABASE', env('DB_DATABASE', 'artdent_admin')),
            'username' => env('CENTRAL_DB_USERNAME', env('DB_USERNAME', 'fer_dev')),
            'password' => env('CENTRAL_DB_PASSWORD', env('DB_PASSWORD', 'password_local')),

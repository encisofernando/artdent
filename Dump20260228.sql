...
CREATE TABLE `clinics` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  `type` enum('clinica','odontologo','otrolab','colegio','particular') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'clinica',
  `cuit` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `clinics` VALUES (1,2,'CARLOS CONSIGLIO',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2026-02-28 00:37:31','2026-02-28 00:37:31',NULL,'odontologo',NULL,0.00,1),(2,2,'QUAGLIOZZI',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2026-02-28 12:11:14','2026-02-28 12:11:14',NULL,'odontologo',NULL,0.00,1),(3,2,'DARIO CRISTALDO',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2026-02-28 13:00:02','2026-02-28 13:00:02',NULL,'odontologo',NULL,0.00,1);
...
CREATE TABLE `collaborators` (
  ...
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `faceio_fid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `costs` (
  ...
  `type` enum('material','mano_obra','herramienta','logistica','otros') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `customer_receipts` (
  ...
  `user_id` bigint unsigned DEFAULT NULL COMMENT 'Usuario que registró',
  `receipt_number` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Número de recibo generado: RC-XXXX',
  `receipt_date` date NOT NULL,
  `type` enum('cobro','pago') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cobro' COMMENT 'cobro = cliente paga / pago = devolvemos dinero al cliente',
  `amount_cash` decimal(14,2) NOT NULL DEFAULT '0.00' COMMENT 'Efectivo',
  `amount_transfer` decimal(14,2) NOT NULL DEFAULT '0.00' COMMENT 'Transferencia bancaria',
  `amount_check` decimal(14,2) NOT NULL DEFAULT '0.00' COMMENT 'Cheque',
  `amount_card` decimal(14,2) NOT NULL DEFAULT '0.00' COMMENT 'Tarjeta débito/crédito',
  `total` decimal(14,2) NOT NULL DEFAULT '0.00' COMMENT 'Suma de todos los medios',
  `check_number` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'N° cheque',
  `check_bank` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Banco del cheque',
  `check_due_date` date DEFAULT NULL COMMENT 'Fecha de vencimiento del cheque',
  `account_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Caja / Banco destino',
  `reference` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Referencia externa / N° transferencia',
  `note` text COLLATE utf8mb4_unicode_ci COMMENT 'Observación libre',
  `ledger_entry_id` bigint unsigned DEFAULT NULL COMMENT 'FK al ledger_entry generado',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_receipt_customer_date` (`customer_id`,`receipt_date`),
  KEY `customer_receipts_user_id_foreign` (`user_id`),
  KEY `customer_receipts_ledger_entry_id_foreign` (`ledger_entry_id`),
  CONSTRAINT `customer_receipts_company_id_foreign` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `customer_receipts_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `customer_receipts_ledger_entry_id_foreign` FOREIGN KEY (`ledger_entry_id`) REFERENCES `ledger_entries` (`id`) ON DELETE SET NULL,
  CONSTRAINT `customer_receipts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customer_receipts` VALUES (1,2,2,1,'RC-0001','2026-02-27','cobro',100000.00,0.00,0.00,0.00,100000.00,NULL,NULL,NULL,'Caja',NULL,NULL,1,'2026-02-27 12:57:42','2026-02-27 12:57:42',NULL);
...
CREATE TABLE `customers` (
  ...
  `email` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `document` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `city` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zip` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `deliveries` (
  ...
  `status` enum('pending','assigned','in_transit','delivered','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `job_items` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `job_items_job_id_index` (`job_id`),
  KEY `job_items_tariff_id_index` (`tariff_id`),
  CONSTRAINT `job_items_job_id_foreign` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`id`) ON DELETE CASCADE,
  CONSTRAINT `job_items_tariff_id_foreign` FOREIGN KEY (`tariff_id`) REFERENCES `tariffs` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `job_items` VALUES (1,1,1,'Corona de Zirconio',NULL,110000.00,4,0.00,NULL,NULL,NULL,'2026-02-28 14:26:30','2026-02-28 14:26:30',NULL),(2,2,1,'Corona de Zirconio',NULL,110000.00,1,0.00,NULL,NULL,NULL,'2026-02-28 15:04:34','2026-02-28 15:04:34',NULL);
...
CREATE TABLE `job_payments` (
  ...
  `payment_method` enum('cash','card','transfer','check','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'cash',
...
INSERT INTO `job_payments` VALUES (1,2,NULL,50000.00,'cash','2026-02-28',NULL,NULL,1,'2026-02-28 15:05:07','2026-02-28 15:05:07');
...
CREATE TABLE `job_teeth` (
  ...
  `position` enum('upper','lower') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `job_types` (
  ...
  `color` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '#397B9C',
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `jobs` (
  ...
  `work_type` enum('ticket','budget') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'ticket',
  `status` enum('pending','in_progress','completed','delivered','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
...
INSERT INTO `jobs` VALUES (1,2,'LAB-KQ4HWIJQ',3,NULL,1,NULL,'2026-02-28','2026-02-28',NULL,'ticket','pending','normal',440000.00,0.00,0.00,440000.00,NULL,NULL,NULL,NULL,1,1,'2026-02-28 14:26:30','2026-02-28 14:26:30',NULL),(2,2,'LAB-PZ0IMUCQ',3,NULL,1,NULL,'2026-02-28','2026-02-28',NULL,'ticket','pending','normal',110000.00,0.00,0.00,110000.00,NULL,NULL,NULL,NULL,1,1,'2026-02-28 15:04:34','2026-02-28 15:04:34',NULL);
...
CREATE TABLE `movements` (
  ...
  `date` date NOT NULL,
  `type` enum('charge','payment') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `movements_client_id_foreign` (`client_id`),
  KEY `movements_job_id_foreign` (`job_id`),
  KEY `movements_company_id_client_id_date_index` (`company_id`,`client_id`,`date`),
  CONSTRAINT `movements_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clinics` (`id`),
  CONSTRAINT `movements_company_id_foreign` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`),
  CONSTRAINT `movements_job_id_foreign` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `movements` VALUES (1,2,3,'2026-02-28','charge',110000.00,'Orden de trabajo LAB-PZ0IMUCQ',NULL,'LAB-PZ0IMUCQ',2,'2026-02-28 15:04:34','2026-02-28 15:04:34',NULL);
...
CREATE TABLE `notifications` (
  ...
  `company_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned DEFAULT NULL,
  `type` enum('order_status','price_alert','back_in_stock','promotion','review_response','system') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `order_tracking` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `order_id` bigint unsigned NOT NULL,
  `status` enum('pending','confirmed','processing','shipped','in_transit','out_for_delivery','delivered','cancelled','refunded') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `patients` VALUES (1,2,'Fanny','Zeballos',NULL,'female',NULL,NULL,NULL,NULL,'2026-02-28 12:57:35','2026-02-28 12:57:35',NULL);
...
CREATE TABLE `payment_transactions` (
  ...
  `company_id` bigint unsigned NOT NULL,
  `order_id` bigint unsigned NOT NULL,
  `gateway` enum('mercadopago','stripe','manual','transfer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mercadopago',
  `transaction_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `preference_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` decimal(10,2) NOT NULL,
  `currency` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ARS',
  `status` enum('pending','approved','authorized','in_process','in_mediation','rejected','cancelled','refunded','charged_back') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `payment_type_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product_analytics` (
  ...
  `event_type` enum('view','click','add_to_cart','add_to_wishlist','purchase') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tariffs` (
  ...
  `unit` enum('pieza','juego','kit','par','unidad') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `active` tinyint(1) DEFAULT '1',
...
INSERT INTO `tariffs` VALUES (1,2,'1','Corona de Zirconio','Coronas y Puentes','pieza',1,110000.00,99000.00,93500.00,88000.00,82500.00,'2026-02-28 13:47:25','2026-02-28 13:47:25',NULL);
...
-- Dump completed on 2026-02-28 12:08:29

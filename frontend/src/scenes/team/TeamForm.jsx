...
useEffect(() => {
  // Esto será un buen lugar para verificar que los permisos iniciales están correctos
  console.log("Permisos iniciales:", initialPermissions);
}, [initialPermissions]);
...
const handleSaveClick = async () => {
  console.log("handleSaveClick se ha disparado");
...
for (const pair of formDataToSend.entries()) {
  ...
  try {
    console.log("Intentando crear empleado con los datos:", formDataToSend);
    console.log("Intentando crear empleado con los datos:", formDataToSend);

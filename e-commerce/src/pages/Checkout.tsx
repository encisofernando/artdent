  ...
  return (
    <div className="space-y-5">
      <div className="card p-6 space-y-4">
        ...
        {/* Andreani cotiza y busca sucursales por código postal — ciudad/provincia
            no aportan nada real a domicilio ni a sucursal, así que no se le
            piden al cliente acá (quedan con el valor ya prellenado internamente,
            solo se usan como respaldo para la disponibilidad de moto). */}
        <div>
          <label htmlFor="checkout-postal-top" className="text-xs font-semibold text-gray-600">Código Postal</label>
          <input
            id="checkout-postal-top"

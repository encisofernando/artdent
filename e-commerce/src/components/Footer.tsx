...
const TT_URL = 'https://www.tiktok.com/@artdent.insumosodonto'
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <a href={TT_URL} target="_blank" rel="noopener noreferrer"
        className="w-9 h-9 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition" aria-label="TikTok">
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
